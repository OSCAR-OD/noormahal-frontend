  ...
  settings: [
    {
      ...
      site: {
        name: 'NoorMahal',
        description:
          'NoorMahal is a website where you can book rooms.',
        keywords: 'Next.js, Tailwind CSS, MongoDB',
        url: 'https://next-mongo-ecommerce-final.vercel.app',
        logo: '/icons/logo.svg',
        slogan: 'Spend less, enjoy more.',
        author: 'NoorMahal',
        copyright: '2000-2024, NoorMahal.com. ',
        email: 'admin@example.com',
        address: '123, Main Street, China, CA, Zip 12345',
        phone: '+1 (123) 456-7890',
      },
      carousels: [
        {
